...
class OasisProfileGenerator:
    ...
    def __init__(
        ...
        # Zep client for retrieval enrichment
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        """
        Use Zep graph hybrid search to obtain rich information related to entity

        Zep has no built-in hybrid search interface, so edges and nodes are searched
