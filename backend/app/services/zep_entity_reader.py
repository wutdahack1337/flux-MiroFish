...
Reads nodes from the Zep graph and filters nodes matching predefined entity types
"""
...
class ZepEntityReader:
    ...
    def filter_defined_entities(
        ...
        Filter logic:
        - If a node's Labels contain only "Entity", it doesn't match our predefined types — skip
        - If a node's Labels contain labels beyond "Entity" and "Node", it matches — keep
        ...
        for node in all_nodes:
            ...
            # Filter: Labels must include something beyond "Entity" and "Node"
