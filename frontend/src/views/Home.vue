    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even from a single paragraph, <span class="highlight-bold">MiroFish</span> can automatically generate a parallel world of up to <span class="highlight-orange">one million agents</span> based on real-world seeds in the text. Inject variables from a top-down perspective and search for <span class="highlight-code">"local optima"</span> in complex group interactions under dynamic conditions.
            </p>
            <p class="slogan-text">
              Rehearse the future in agent populations, and let decisions win after countless trials<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine is standing by. Upload multiple unstructured files to initialize the simulation sequence.
          </p>
          ...
          <div class="metrics-row">
            <div class="metric-card">
              ...
              <div class="metric-label">Regular simulations average $5 per run</div>
            </div>
            <div class="metric-card">
              <div class="metric-value">High Availability</div>
              <div class="metric-label">Supports simulations with up to one million agents</div>
            </div>
          </div>
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Extract real-world seeds, inject individual and group memory, and build GraphRAG</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Extract entity relations, generate personas, and inject simulation parameters via the environment-config agent</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Parallel simulation on two platforms, automatic prediction-intent parsing, and dynamic temporal-memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Talk to any individual in the simulated world and converse with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter your simulation or prediction request in natural language (e.g., If a university revokes a disciplinary decision, what public opinion trend may follow?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Start simulation: navigate immediately; API call is handled on the Process page
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Jump to Process page immediately (special marker indicates a new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  /* 
    ...
    Make sure these Google Fonts are included in index.html.
  */
...
/* Project simulation workflow section */
.steps-container {
  border: 1px solid var(--border);
  padding: 30px;
  position: relative;
